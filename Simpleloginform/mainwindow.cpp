    ...
    : QMainWindow(parent)
{
    ...
    lab->move(70,110);
    QPixmap pixx("C:/Users/Harish/Documents/Simpleloginform/username.png");
    ...
    QPixmap pix("C:/Users/Harish/Documents/Simpleloginform/login.jpg");
    ...
    labb->move(70,180);
    QPixmap pixxx("C:/Users/Harish/Documents/Simpleloginform/password.png");
    ...
    QPixmap pixxxx("C:/Users/Harish/Documents/Simpleloginform/signup.png");
    ...
    connect(button2,&QPushButton::clicked,[=](){
        if(unLineEdit->text() == "hariishh" && pwdLineEdit->text() == "123456")
        {
